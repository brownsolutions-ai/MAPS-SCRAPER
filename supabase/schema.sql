...
create table if not exists public.companies (
  ...
  country_code text not null default 'BR' check (country_code in ('BR','PT','ES','IT','GB','DE','NL','IE','CH','AT','US')),
...
alter table public.import_batches add column if not exists country_code text not null default 'BR';
...
create index if not exists companies_country_status_idx on public.companies(country_code, status);
...
create index if not exists import_batches_country_idx on public.import_batches(country_code, created_at desc);
...
-- Expandir os países sem modificar empresas existentes.
alter table public.companies drop constraint if exists companies_country_code_check;
alter table public.companies add constraint companies_country_code_check check (country_code in ('BR','PT','ES','IT','GB','DE','NL','IE','CH','AT','US'));
alter table public.import_batches drop constraint if exists import_batches_country_code_check;
alter table public.import_batches add constraint import_batches_country_code_check check (country_code in ('BR','PT','ES','IT','GB','DE','NL','IE','CH','AT','US'));
